      ...
      states: {
        'Capital Contribution': {
          ...
          on: {
            'Operator Raises Issue': {
              target:
                '#Incorporation KG (Version 4).Document Collection.Capital Contribution.Pending Issue Handling by Operator',
            },
          },
          states: {
              ...
              states: {
                    ...
                    'Waiting for Capital Deposit Payment Confirmation by ZKB': {
                      on: {
                        'ZKB Sends Capital Deposit Payment Instruction to Jurata':
                          {
                            target:
                              '#Incorporation KG (Version 4).Document Collection.Capital Contribution.Pending Final Documents Check from Operator',
                          },
                      },
                    },
                  },
                ...
                Disapproved: {
                  on: {
                    'ZKB Submits Capital Deposit Feedback to Jurata': {
                      target:
                        '#Incorporation KG (Version 4).Document Collection.Capital Contribution.Waiting for Capital Deposit Payment Confirmation from Client',
                    },
                  },
                },
              },
      ...
      states: {
        ...
        'Pending Issue Handling by Operator': {
          on: {
            ...
            'Operator Handles Issue via Notary': {
              target:
                '#Incorporation KG (Version 4).Incorporation Act with Notary.Pending Processing by Operator',
            },
          },
        },
      },
